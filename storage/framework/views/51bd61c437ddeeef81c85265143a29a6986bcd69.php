        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  open ">
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="<?php echo e(route('admin.languages.create')); ?>" data-i18n="nav.dash.crypto">أضافة
                            لغة جديده </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    ...
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2"><?php echo e(App\Models\MainCategory::count()); ?></span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="<?php echo e(route('admin.maincategories')); ?>"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="<?php echo e(route('admin.maincategories.create')); ?>" data-i18n="nav.dash.crypto">أضافة
                             قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="<?php echo e(route('admin.vendors')); ?>"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="<?php echo e(route('admin.vendors.create')); ?>" data-i18n="nav.dash.crypto">أضافة
                            متجر  </a>
                    </li>
                </ul>
            </li>
...
</div><?php /**PATH C:\wamp64\www\ecommerce\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>