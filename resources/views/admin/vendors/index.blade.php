                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <a href="{{route('admin.maincategories')}}">الرئيسية</a>
                                    المتاجر 
                                        ...
                                        <table
                                            ...
                                            @isset($vendors)
                                                @foreach($vendors as $vendor)
                                                    <tr>
                                                        <td>{{$vendor -> name}}</td>
                                                        <td><img style="width:100%; height:100px;" src="{{$vendor -> logo}}"></td>
                                                        <td>{{$vendor -> mobile}}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">@if ($vendor->active == 0) تفعيل  @else الغاء التفعيل  @endif</a>
